...
import com.androidstrike.trackit.databinding.FragmentFacilitySignUpBinding
...
class FacilitySignUp : Fragment() {
    ...
    lateinit var facilityAddress: String
    lateinit var facilityAddressLongitude: String
    lateinit var facilityAddressLatitude: String
    lateinit var facilityPhoneNumber: String
    lateinit var facilityPassword: String
    lateinit var facilityConfirmPassword: String
