...
import com.androidstrike.trackit.databinding.FragmentFacilityNotificationBinding
...
//                        facilityBaseFragment!!.view?.findViewById<TabLayout>(R.id.facility_base_tab_title)
                    ...
                    holder.dateCreated.text = getDate(model.dateScheduled.toLong(), "EE, dd MMMM, yyyy")
                    holder.timeCreated.text = model.scheduledTime
